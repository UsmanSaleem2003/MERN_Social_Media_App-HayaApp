    ...
    return (
        <div className='post'>
            ...
            <div className='content-pic'>
                <img src={`data:image/jpeg;base64,${arrayBufferToBase64(postData.content_pic.data)}`} alt="content-pic" />
            </div>

            <div className='bottom'>
                <div className='post-buttons'>
                    <img src={like_btn} alt='like_btn' onClick={handleAddLike} />
                        ...
                        {postData.post_comments.map((comment, index) => (
                            <div key={comment.id || index} className='comment'>
                                ...
                                {comment.commentby._id === postData.currentUser &&
                                    <button className='delete-comment' onClick={() => handleDeleteComment(postData.id, comment._id)}>Delete</button>
                                }
                            </div>
                        ))}
                    </div>
